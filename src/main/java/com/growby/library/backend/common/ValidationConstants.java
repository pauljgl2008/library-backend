...
public class ValidationConstants {
    ...
    public static final String LOAN_NOT_FOUND_MESSAGE = "El préstamo no fue encontrado con el id proporcionado.";
    ...
    public static final String AUTHOR_NOT_FOUND_MESSAGE = "El autor no fue encontrado con el id proporcionado.";
    public static final String AUTHOR_NAME_EXISTS_MESSAGE = "El nombre del autor ya existe.";
